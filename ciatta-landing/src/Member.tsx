...
const QUESTIONS: [string, string][] = [
  ...
  ['What does it cost?',
   'Ciatta Core is $99 for the year — one membership, one payment, and continuous access for the year rather than a subscription that starts over every thirty days. Reserving a place costs nothing, takes no card, and charges nothing today.'],
];
