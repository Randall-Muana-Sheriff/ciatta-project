...
-- Item 9 (the Data API grants this project's tables and views need) was
-- first added here, then moved out to its own migration,
-- 20260915100400_exact_grants.sql, once a re-review found it granted
-- without revoking first -- see that file for the fix and why.
